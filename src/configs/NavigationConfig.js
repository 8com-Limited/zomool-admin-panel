...
const extraNavTree = [
  ...
  //   //       },
  //   //       {
  //   //         key: 'extra-pages-service-list',
  //   //         path: `${APP_PREFIX_PATH}/pages/service-list`,
  //   //         title: 'sidenav.pages.servicelist',
  //   //         icon: '',
  //   //         breadcrumb: false,
  //   //         submenu: [],
  //   //       },
  //   //       {
  //   //         key: 'extra-pages-request-service-list',
  //   //         path: `${APP_PREFIX_PATH}/pages/request-service-list`,
  //   //         title: 'Request Services List',
  //   //         icon: '',
  //   //         breadcrumb: false,
  //   //         submenu: [],
  //   //       },
    ...
    submenu: [
      {
        ...
        submenu: [
          {
            key: "extra-pages-hospitals",
            path: `${APP_PREFIX_PATH}/pages/hospitals`,
          ...
          {
            key: "extra-pages-pharmacies",
            path: `${APP_PREFIX_PATH}/pages/pharmacies`,
      ...
      {
        key: "TransportationSub",
        path: `${APP_PREFIX_PATH}/Transportation`,
        title: "Transportation",
        icon: "",
        breadcrumb: false,
        submenu: [
          {
            key: "extra-pages-vehicle",
            path: `${APP_PREFIX_PATH}/pages/vehicle`,
            title: "Vehicle List",
            icon: "",
            breadcrumb: false,
            submenu: [],
          ...
          {
            key: "extra-pages-driver",
            path: `${APP_PREFIX_PATH}/pages/driver`,
            title: "Driver List",
            icon: "",
            breadcrumb: false,
            submenu: [],
  ...
  {
    key: "extra-pages-feed",
    path: `${APP_PREFIX_PATH}/pages/feed`,
    title: "Feed List",
    icon: "",
    breadcrumb: false,
    submenu: [],
  ...
  {
    key: "extra-pages-accessories",
    path: `${APP_PREFIX_PATH}/pages/accessories`,
